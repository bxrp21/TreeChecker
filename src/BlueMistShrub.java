...
public class BlueMistShrub extends FloweringTree {
 ...
 * @param name
 */
	public BlueMistShrub(int blossomStartDay, int blossomEndDay, int blossomStartHour, int blossomEndHour) {
		super(blossomStartDay, blossomEndDay, blossomStartHour, blossomEndHour, "Blue Mist Shrub");
